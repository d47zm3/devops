...
echo "192.168.100.101 docker01.devops.pl docker01" | sudo tee -a /etc/hosts
echo "192.168.100.102 devops02.devops.pl docker02" | sudo tee -a /etc/hosts
ssh-keyscan docker01 | sudo tee -a /root/.ssh/known_hosts
ssh-keyscan docker02 | sudo tee -a /root/.ssh/known_hosts
